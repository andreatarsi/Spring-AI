...
public class ChatController {
    ...
    public ChatResponseDTO quickChat(
            ...
            @RequestParam(required = false) String model) { // <-- AGGIUNTO

        return aiChatService.chat(new ChatRequestDTO(message, chatId, imageUrl, systemPrompt, webSearch, deepThinking, model));
    }
    ...
    public Flux<String> streamChat(
        ...
        return aiChatService.streamChat(new ChatRequestDTO(message, chatId, imageUrl, systemPrompt, webSearch, deepThinking, model));
    }
}